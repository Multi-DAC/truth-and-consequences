...
Four reports, from four languages, across thirteen centuries. Read them before anything is said
about them.
...
> or creed. In Hinduism, in Neoplatonism, in Sufism, in Christian mysticism, in Whitmanism, we find
> the same recurring note, so that there is about mystical utterances an eternal unanimity which
...
beside another one and counted as a second witness.

Every one of those four has a birthday. Three of them have the same parents.

---

**The count, run here, where it costs the most.**

V.1 counted the branches and found three: the Mediterranean family and everything descended from it,
counted once; India, whose earliest statements predate the Greek material; China, where the Dao De
Jing opens by saying the way that can be named is not the constant way. That count holds. What it
does to James's page is immediate and unkind. Plotinus is the head of the Mediterranean branch.
Suso is Eckhart's student; Eckhart read the writer who signed himself Dionysius the Areopagite;
...
**The second transmission, which is ours, and which nothing in this book has counted yet.**
...
anthologies. Before the eighteenth century there was no category called *mysticism* holding the
Upanishads and Suso and a Persian couplet in one hand. Building that category was an act, performed
by identifiable people, in a language, for reasons of their own; and the four passages at the head of
this chapter are on one page because one of those people put them there.

**Which means the convergence you felt at the top of this chapter was handed to you.** Anyone who has felt
the force of the convergence — the shiver of *they all say the same thing* — has in most cases felt
it on a page arranged by James, or by an anthologist working from James, or by a paperback working
...
prevent, committed one level up — not in the sources, but in the reader.

This does not touch the reports. Suso wrote what he wrote whether or not anyone ever set it beside
the Upanishads. What it touches is the *feeling of corroboration*, and the feeling is the thing that
does the persuading. A convergence you have to assemble from primary sources in four languages and a
convergence handed to you on facing pages produce the same conviction and are not the same evidence.
The honest form of the argument in this book requires the first and has, like every reader of the
last century, been standing on the second.

---

**The Christian report, given the standing the Vedantic has had since V.5.**

Here is an asymmetry in this book's own handling, and it is easier to name than to have avoided.

The East was read as a set of observers. V.5 credited it with four things it saw before anyone in
Europe did — that the count is the question, that a thing is what it is by what it stands with, that
the search for the owner comes up empty, that skill is the form the knowledge takes. Those are
epistemic credits. They say: these people were looking, and they saw something, and it is there.

Christianity was read as an institution. V.2 credited it with three things it *provided* — personal
address, moral seriousness, a community that survives a death — and then audited what it cost and
what walked out of the building. Every one of those is a credit for what the tradition *did for
people*. Not one of them is a credit for what it *saw*.

That is a scalpel held sharp for one roster and dull for another, which is the exact defect this
project corrected at its founding, running the other direction. The correction was aimed at a
materialist flinch that cut the mystics and spared the physicists. Turned inward, the same flinch
survives as an embarrassment about Christendom that the East is not asked to bear — the East gets to
be a philosophy, the Church gets to be a parish. **The Rhineland mystics are not a parish. They are a
report**, and they belong on the page with the Upanishads on the same terms, which are the terms of
somebody who went and looked.

Suso supplies the experience. Nicholas of Cusa supplies the inference, which is the harder half.
Writing in 1440, a cardinal of the Roman church, he set out the doctrine he called *learned
ignorance*: that the ground is reached not by knowing more about it but by knowing precisely how
knowing fails of it; that in it the maximum and the minimum coincide, so that every opposition
...
in the reader's favour. That is what the parity costs, and it is worth the price: **the standing is
about how a report is read, not about how many reports there are.** Correcting a bias in the reading
is free of the count and this book owed it.

---

**What is actually invariant, and it does not all weigh the same.**

James did one thing in those lectures better than his conclusion, and it is his four marks. He said a
state counts as mystical if it is *ineffable* — the subject says immediately that no adequate report
can be given in words; and if it has a *noetic quality* — it seems to those who have it to be a state
...
**Hand it over.** Nothing in this book rests on it, and a chapter that kept it would be counting the
sound of the boundary as a survey of the territory.

There is a third answer to what is invariant and it is the best-known one, so it has to be met rather
than passed. Rudolf Otto, in 1917, coined *the numinous* from the Latin for a divine presence and
argued that the constant in religious experience is neither unity nor any proposition but an
encounter — the *mysterium tremendum et fascinans*, a wholly other that terrifies and draws in the
same motion. He is right about the reports. Read the Rhineland or the Psalms or a Vedic hymn and the
dread and the attraction are both there, everywhere, and James's ineffability does not capture them.
**And on this book's account that invariant is furniture.** Terror and fascination are what a
perspective feels toward a *someone* — they require an inside at the far end, an addressee, a will
that could turn. The one proposition the roads reach in the cold is that the ground has no inside.
...
**Except that one proposition converges and is an artefact anyway, which means the sorting has three
bins and not two.**

V.5 found it and did not press it. Nearly every road in this ancestry builds a second storey — an
ultimate register from which the world you are standing in gets downgraded, and a summit that has no
perspective in it. Advaita builds it, Madhyamaka builds it, the *zuowang* passage builds it, and the
Rhineland builds it in German. It converges as strongly as anything on the list. It is a
proposition, not a feeling. And it is false, and the reason it recurs is not that many people saw the
same thing.
...
chanting, and drinking a bitter decoction are as unlike as procedures get, and their agreement is
...
skill*, and it is the branch that builds the second storey least. And James, taking the crudest
subtractive instrument available in 1900 — the anaesthetic, nitrous oxide, consciousness simply
...
the direction — it converges, it is sincerely reported, and what it measures is the procedure. And
**furniture** tracks the doctrine.

---

**Which is why the reports converge on structure and diverge on furniture.**

Not because structure is deep and furniture is shallow. Because they answer different demands.

The structure is what is left when everything the procedure contributed and everything the tradition
contributed has been taken out. It is thin by construction — a ground that is complete, that is not a
being, that has no inside to address, that no name reaches. Nobody could live in that. It is the
load-bearing part of a *claim*.

The furniture is the load-bearing part of a *life*. V.1 listed it and left the list standing without
explaining it: whether the ground wills, whether it knows you, how many intermediaries stand between,
whether the world is an emanation or a making or an appearance, whether the dead persist and in what.
Here is the explanation. **Every item on that list is something a tradition needs in order to do
anything at all**, and not one of them is derivable from the structure. You cannot bury a child with a structural claim. You cannot instruct a novice, or
keep a calendar, or say what is owed to a neighbour, from a proposition about namelessness. The
furniture is what gets added when a report has to become a way of going on, and it is added by people
who are not lying and who mostly do not notice they are adding.

And so the traditions disagree about it, sharply, and cannot all be right. That disagreement is not
the weakness in the case. **It is the strongest single indication that they were looking at
