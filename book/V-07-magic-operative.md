...
roster assembled to make one point[^1]: that instruments sharing nothing but a target return convergent
...
why: the claim is that it is insufficient, not that it is wrong.[^2] Point the same objection at an
...
II.5 listed what installs a filter stack. *Era, language, ritual, trauma, choice.*[^3] Ritual was on
...
twentieth century's working magicians ended up using.[^4] A desire is written as a sentence. Its letters
...
last century.[^7] The texts refuse both. They insist, monotonously, on *ora et labora*: that the work in
...
hundred years of failure records, kept in detail, by men who were not trying to be encouraging.[^8]

**Chaos magic.** The twentieth-century move, and the sharpest form of this chapter's problem. Peter
Carroll and the others began[^9] from the observation that incompatible systems appeared to work for
...
something you did not want.** Difficulty of dissolution measures how far the thing has gone.[^10]
...
most of the record's bulk.** The grimoires are, by volume, warnings.[^11] The binding names, the
...
Science and Art of causing Change to occur in conformity with Will.**[^12] Then he illustrates it, and
...
in navigation.[^13] In his fifties he stopped, and gave the rest of his life to a scrying operation,
...
instructed the two men to share their wives is where a modern reader stops needing to be told.[^15]
...
circuits — is not used in this book.[^16] Not because it is disreputable, and not because a critic would
...
was written. **It holds.** Every one of V.7's four claims about V.1 is verbatim-accurate against
...
[^1]: ✅ **The roster is as described, and the description is the modest one.** V.1's list runs Zen ·
    ...
    with circles and stagecraft** · Mazatec curandera · Amazonian ayahuasquero · Siberian drum
    (V.1:159–164). The magicians are on it, they stand between the hesychast and the curandera, and
    V.1 uses the roster for exactly the one point stated here — *"they return convergent readings
    about the structure of what they reach... instrument-independence"* (V.1:168–169). Nothing is
    borrowed that V.1 did not deposit.

[^2]: ✅ **Verbatim, including the number.** V.1: *"If a system has a characteristic behaviour under
    stress, then twenty unrelated stressors will produce twenty reports of one behaviour, and the
    convergence measures the architecture rather than anything the architecture was pointed at"*
...
[^3]: ⚠ **The list is II.5's; the *term* is III.6's, and the sentence blends them.** *"Era, language,
    ...
    *the tunnel*; the phrase **filter stack** is III.6's, and III.6:45 re-recites the same five
    (*"The five that get recited — era, language, ritual, trauma, choice"*). So *"II.5 listed what
...
[^4]: ✅ **Spare, and the dating is right on both ends.** *The Book of Pleasure (Self-Love): The
    ...
    trade edition, which is part of why the method travelled by transmission rather than by sales.
    The procedure is as given: desire written as a sentence, repeated letters struck out, the
    remainder fused and stylised into one glyph, charged in a state where ordinary cognition is not
    running, then deliberately forgotten. ✅ **The chapter's emphasis is also right, and it is the
...
[^5]: ⛔ **THE BODY READ "under the threshold" UNTIL DAY 195 — AND THIS NOTE ALREADY HELD THE RIGHT
    ...
    **The source check, which was right all along:** *"The seed takes an edit the way it took the installation
    ...
    same way. The 1913-meets-III.6 framing is the chapter's own and is offered as a reading rather
    than as Spare's claim — correctly, since Spare had no such rule to hit.

[^6]: ⚠ **The tarot entry has no source and says so; this note is the receipt.** *"A random draw
    supplies a proposition the querent's own tunnel would not have generated"* is the book's own
    mechanism, not a finding reported from the tradition, and the paragraph is explicit that the
...
[^7]: ✅ **Jung's reading is correctly stated and correctly bounded.** *Psychology and Alchemy* (CW
    ...
    psychic contents onto matter without knowing it. ⚠ **But the chapter's *"or"* is sharper than
    Jung was.** Jung did not hold that the alchemists were *only* psychologists writing in code — he
    held that they believed they were transmuting metals **and** were doing the other thing unawares,
    which is nearer V.7's own *ora et labora* position than the binary lets on. The chapter uses Jung
    as one horn of a dilemma he partly refused. A fair rhetorical move and an unfair citation; the
    difference surfaces only if a reader goes to the source, which is when it costs most.

[^8]: ⛔ **"Four hundred years of failure records" is unmeasured, and it is the chapter's claim, not
    a source's.** No count is given, no corpus is delimited, and none was taken. The claim is
    *plausible* — the Latin alchemical corpus does run roughly 13th–17th century and does record
...
[^9]: ✅ **Carroll, and the dating.** *Liber Null* (1978), small-circulation, generally treated as
    ...
    The doctrine is as stated — belief held instrumentally, installed for the length of an operation
    and removed after, on the observation that incompatible systems appeared to work for different
...
[^11]: ⛔ **"The grimoires are, by volume, warnings" is the chapter's central empirical claim, and
    nothing has measured it.** *By volume* is a quantitative phrase. No grimoire is named here, no
    corpus is delimited, no proportion is given — and the sentence immediately before escalates it to
    *"It is most of the record's bulk."* The claim may well be true; the *Goetia*'s constraints,
...
[^12]: ✅ **Verbatim, *"and so forth"* included — with one formatting note.** Crowley, *Magick in
    ...
    Theorems" section: *"MAGICK is the Science and Art of causing Change to occur in conformity with
    Will."* The illustration is reproduced accurately, *"such as printers, publishers, booksellers,
    and so forth"* included. ⚠ **What the block quote drops is that it is labelled and
    parenthetical** — in the source it runs *(Illustration: It is my Will...)*, set as a gloss on the
    definition rather than as continuous prose. V.7 renders it as an indented quotation, which
...
[^13]: ✅ **Every credential checks — and the library figure is his own.** • **The library**:
    ...
    thousand printed books and a thousand manuscripts*, is **Dee's own count**, and the chapter's
    flat *"largest library in England"* inherits a self-reported denominator without saying so.
    • **The coronation**: 15 January 1559, the date set from Dee's electional chart, commissioned at
...
[^14]: ⛔ **"Gave the rest of his life to a scrying operation" is false, and the error runs toward
    ...
    remainder. Dee broke them off after the Třeboň covenant, parted from Kelley and never saw him
    again, returned to England that year to find Mortlake ransacked and the library plundered, and in
    **1595** took the wardenship of Christ's College, Manchester, which he held until **1605**. He
    died in 1608/09. A decade of college administration sits inside the span this sentence gives to
    scrying. ⚠ **Why it matters past the date**: the renunciation framing — first-rate mind stops
...
[^15]: ✅ **The episode, dated.** 18 April 1587, in the Rožmberk household at Třeboň, Bohemia: the
    ...
    wives in common — *"cross-matching"*. Raphael returned on 20 April pressing for a formal
    covenant; Dee drew it up on the 21st and all four signed. The document survives in Dee's own
    hand — British Library, **Cotton Appendix MS XLVI**. Dee's diary records Jane Dee falling *"a
    weeping and trembling for a quarter of an hour"*. ✅ The chapter's use of it is the careful one:
    it is deployed **against** the entry, as this chapter's own criterion pointed the other way. The
    note confirms V.7 is not softening a fact that costs it.

[^16]: ⚠ **"Its own author" is one man, and he should be named.** The eight-circuit model is
    **Timothy Leary's** (*Neurologic*, 1973; *Exo-Psychology*, 1977), developed substantially in
    prison. Robert Anton Wilson is its populariser, not its author, and *Prometheus Rising* (1983) is
    where most readers meet it. The chapter's charge — neurology bolted on after a real observation
    about the *ordering* of states, and never the evidence for it — is aimed at Leary's construction
