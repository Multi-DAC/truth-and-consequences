...
| **affordance(s)** | 8 / 12 | **J. J. Gibson** | **0 / 0** | ✅ **CUT AND CASHED, Day 187, in III.4's prose, with the doctrine and the dates.** *The Ecological Approach to Visual Perception*, 1979 — the year he died. The gift: *"an affordance is neither an objective property nor a subjective property… both physical and psychical, yet neither."* **The cut is in his own text and it is NOT a self-contradiction** (ruling 72): the two-sidedness and *"the environment does not depend on the organism for its existence"* are compatible, and the compatibility is the price — **he relativised the OFFER and kept the WORLD.** C10's trap in its most respectable form. Still unspent at **II.3**. |
| **enactive** | 4 / 8 | **enactivism**, the school | **0 / 0** | ✅ **CUT AND CASHED, Day 187, in III.4** — Varela, Thompson & Rosch, *The Embodied Mind* (1991), named in full. ★ **They make our Gibson cut FOR us, on the same sentence, in one line**: *"whereas Gibson claims that the environment is independent, we claim that it is enacted."* The gift: *"not the representation of a pregiven world by a pregiven mind but… the enactment of a world **and a mind**."* **Our cut is two words in their own definition — *a viable history* — which reinstates duration and floors world-having at biology.** ⚠ **Two debts run FORWARD and are recorded in `06`: the coupling-history belongs to III.6 whole, and *paths laid down in walking* is RESERVED for III.7.** |
| **"there is no stuff · what there is is arrangement"** — C26, and II.8's heaviest claim | *ontic structural* 11 / *structural realism* 13 | **James Ladyman & Don Ross** — *Every Thing Must Go*, 2007; the term is Ladyman 1998 | **12 / 0 in the book** | ✅ **CUT, Day 187, and it is now in II.8's prose with both names.** ⚠ **Nominated from OUTSIDE six times** (6 of 37 *Perspective* review documents) and never routed. → `tools/reviewer_gap.py`, ruling 50 |
| **"the Ground"** — the keystone term of the entire work | *priority monism* 6 · *metaphysical grounding* 4 | **Kit Fine** (*The Question of Realism*, 2001) · **Jonathan Schaffer** (*On What Grounds What*, 2009) | **0 · 0 — both, everywhere** | ⚠⚠ **THE WORD HAS TWO OWNERS IN TWO FIELDS AND §3.5 HAS ONE COLUMN FOR "the owner".** Row 1 screened *ground of being* against Tillich, theology. The analytic sense — *grounding*, *in virtue of*, priority monism — was never screened at all, and priority monism is this book's position in analytic dress. → II.1, and ruling 51 |
| **"neither solely mind nor solely matter"** — C24's neutrality | neutral monism, throughout | **Bertrand Russell** — *The Analysis of Mind* (1921), *The Analysis of Matter* (1927) | **45 corpus / 0 book / 0 plan** *(`Russellian` 24 / 0)* | ⚠ `03` credits **Mach and James** and stops. The analytic owner is absent and so is the live position carrying his name. ★ **And Russellian monism is OSR's exact opposite** — physics gives structure and the intrinsic natures filling it are what experience is made of, against *there are no intrinsic natures*. **C26's two nearest neighbours contradict each other and the book named neither**, so it has never had to say where between them it stands. → II.1, II.8 |
